      ...
      <div className={styles["receipts"]}>
        ...
        >
          <img
            ...
            src={receipts[0]?.images[0]}
            alt={receipts[0]?.title}
            srcSet={receipts[0]?.images[0]}
          ...
          >
            <div className={styles["receipts-title"]}>{receipts[0]?.title}</div>
        ...
        >
          <img
            className={styles["receipts-preview"]}
            src={receipts[1]?.images[0]}
            alt={receipts[1]?.title}
            srcSet={receipts[1]?.images[0]}
            about={receipts[1]?.description}
          />
          <div className={styles["receipts-info"]}>
            <div className={styles["receipts-title"]}>{receipts[1]?.title}</div>
            <div className={styles["receipts-description"]}>
